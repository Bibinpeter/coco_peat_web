...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-[#090a0d]/80 backdrop-blur-xl border-b border-white/5">
      {/* Top Produx-Style Marquee Ticker */}
      <div className="bg-[#0e1117] border-b border-white/5 py-1.5 overflow-hidden text-[11px] font-mono text-gray-400">
        <div className="flex whitespace-nowrap animate-marquee">
          ...
          <span className="mx-6 flex items-center gap-2 text-coir-gold">
            1:15 HYDRATION EXPANSION RATIO (75L YIELD PER 5KG)
          </span>
          <span className="mx-6 text-gray-600">•</span>
          <span className="mx-6 flex items-center gap-2 text-emerald-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-500 group-hover:text-black transition-all duration-300">
            <Leaf className="w-5 h-5 transition-transform group-hover:rotate-12" />
          </div>
          <div className="flex flex-col">
            <span className="font-sans text-lg font-extrabold tracking-tight text-white flex items-center gap-1">
              TERRACOCO<span className="text-emerald-400 font-mono text-xs">®</span>
            </span>
            <span className="text-[10px] font-mono text-gray-400 tracking-widest uppercase">
              BIO-ENGINEERED SUBSTRATES
            </span>
          </div>
        </a>
        ...
        <div className="md:hidden flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-space-850 border border-white/10 text-gray-300"
          >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-space-900 border-b border-white/10 px-6 py-6 space-y-4">
          <a
            href="#products"
            onClick={() => setMobileMenuOpen(false)}
            className="block text-sm font-mono uppercase text-gray-300 hover:text-emerald-400"
          >
            Substrates Catalog
          </a>
          <a
            href="#hydration"
            onClick={() => setMobileMenuOpen(false)}
            className="block text-sm font-mono uppercase text-coir-light hover:text-emerald-400"
          >
            Hydration 3D Simulator
          </a>
          <a
            href="#calculator"
            onClick={() => setMobileMenuOpen(false)}
          ...
          <button
            ...
            className="block text-sm font-mono uppercase text-gray-300 hover:text-emerald-400 w-full text-left"
          >
            Lab Data Specs
          </button>
          <button
            ...
            className="w-full py-3 rounded-lg bg-emerald-500 text-black font-mono text-xs font-bold uppercase tracking-wider"
          >
